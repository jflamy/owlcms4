...
See the application [Web Site](https://jflamy.github.io/owlcms4/#) for a full overview.  See [this page](https://jflamy.github.io/owlcms4/#/Demo) for a live demo.
...
* [Heroku Cloud Installation](https://jflamy.github.io/owlcms4/#/Cloud)
...
*	[Distancing using Individual Scoreboards](https://jflamy.github.io/owlcms4/#/Distancing)
*	[Cloud Installation of the publicresults Application](https://jflamy.github.io/owlcms4/#/Remote)
*	[Virtual Competitions and Remote Referees](https://jflamy.github.io/owlcms4/#/Virtual)
*	[Video-Conference Setup](https://jflamy.github.io/owlcms4/#/Video)
...
If however you wish to provide the software as a service to others (including by hosting it), or if you create a modified version, the license *requires* you to make full sources and building instructions available for free &ndash; just like this software is (see the [License](LICENSE.txt) for details.)
