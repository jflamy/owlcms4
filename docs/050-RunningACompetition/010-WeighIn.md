...
![010_Weighin](img/010-WeighIn/010_Weighin.png)
...
![012_selectGroup](img/010-WeighIn/012_selectGroup.png)

## Quick Mode

If information is provided to you on a weigh-in sheet (see the section on [Documents](../040-CompetitionSetup/040-PreCompetitionDocuments), it will be in the same order as shown on the screen.  If you select Quick Mode, when you hit "Enter" or click on Update, you will be brought automatically to the next athlete and you won't have to look up the names.  So you only need to select the first athlete to get going.
...
![020_selectAthlete](img/010-WeighIn/020_selectAthlete.png)
...
![021_movingUp](img/010-WeighIn/021_movingUp.png)



## Start Numbers

Start numbers are used to ensure that lighter weight categories lift before heavier weight categories even if the same weight is requested.  Start numbers are normally assigned at the end of the weigh in.![030_StartNumbers](img/010-WeighIn/030_StartNumbers.png)
...
![032_StartingWeights](img/010-WeighIn/032_StartingWeights.png)
...
![034_StartingWeights](img/010-WeighIn/034_StartingWeights.png)
