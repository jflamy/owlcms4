...
![010_Lifting](img/070-Announcing/010.png)
...
![012_SelectGroup](img/070-Announcing/020.png)

However, before lifting starts for a group, there is normally an official protocol followed, where athletes and officials are introduced, and a warm-up period is given after the introduction.  Applying this protocol for intermissions and breaks is explained on the [Intermissions and Breaks](./060-Breaks) page.
...
![012a_StartLifting](img/070-Announcing/030.png)
...
![013_ShowCurrent](img/070-Announcing/040.png)
...
![014_StartClock](img/070-Announcing/050.png)
...
![016_StopClock](img/070-Announcing/060.png)
...
![018_SoloGoodLift](img/070-Announcing/070.png)
...
![019_GoodLiftNotification](img/070-Announcing/080.png)
...
![020_EditLifterCard](img/070-Announcing/090.png)
...
![MovingDownError](img/070-Announcing/MovingDownError.png)
...
![022_CurrentAthlete](img/070-Announcing/100.png)
...
![021_ForcedAsCurrent-](img/070-Announcing/021_ForcedAsCurrent-.png)
...
![030_Break](img/070-Announcing/110.png)

You can resume competition by using the `End Break` button.

![031_endTechnicalIssue](img/070-Announcing/120.png)

## Intermissions

See the [Breaks and Ceremonies](./060-Breaks) page for how to manage the timers before introduction, before the first snatch, and before clean&jerk.
...
![040_Marshall](img/070-Announcing/130.png)
...
![timekeeper](img/070-Announcing/140.png)
...
![040_Marshall](img/070-Announcing/150.png)
