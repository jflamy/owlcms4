...
```powershell
<<<<<<< HEAD
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.15.5/download/dd_setup.yaml
=======
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.16.0-rc01/download/dd_setup.yaml
>>>>>>> origin/develop
```
