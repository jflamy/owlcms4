...
```powershell
<<<<<<< HEAD
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.33.0/download/dd_setup.yaml
=======
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.33.1-rc01/download/dd_setup.yaml
>>>>>>> origin/develop
```
