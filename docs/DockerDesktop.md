...
```powershell
<<<<<<< HEAD
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.28.0-alpha05/download/dd_setup.yaml
=======
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.27.3/download/dd_setup.yaml
>>>>>>> origin/master
```
