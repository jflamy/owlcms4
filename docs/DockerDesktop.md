...
```powershell
<<<<<<< HEAD
kubectl apply -f https://github.com/owlcms/owlcms4/releases/45.0.0-alpha01/download/dd_setup.yaml
=======
kubectl apply -f https://github.com/owlcms/owlcms4/releases/44.4.0/download/dd_setup.yaml
>>>>>>> refs/heads/v24
```
