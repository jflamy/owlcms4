...
```powershell
<<<<<<< HEAD
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.33.0-alpha01/download/dd_setup.yaml
=======
kubectl apply -f https://github.com/owlcms/owlcms4/releases/4.32.3/download/dd_setup.yaml
>>>>>>> origin/master
```
