...
- Get a current release [zip](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/download/44.0.0-beta05/owlcms_44.0.0-beta05.zip) from the [release repository](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases)
