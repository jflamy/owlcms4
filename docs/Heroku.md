...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/43.0.6/owlcms_43.0.6.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
