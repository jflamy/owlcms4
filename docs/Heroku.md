...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/40.2.0/owlcms_40.2.0.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
