...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/41.0.2-rc01/owlcms_41.0.2-rc01.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
