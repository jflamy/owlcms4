...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/38.4.0/owlcms_38.4.0.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
