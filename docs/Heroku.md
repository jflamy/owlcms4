...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/39.0.0/owlcms_39.0.0.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
