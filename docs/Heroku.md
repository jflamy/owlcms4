...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/44.6.1/owlcms_44.6.1.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
