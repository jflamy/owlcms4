...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/45.0.3/owlcms_45.0.3.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
