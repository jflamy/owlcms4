...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/44.2.2/owlcms_44.2.2.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
