...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/44.7.1/owlcms_44.7.1.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
