...
- Get a current release [zip](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/download/41.0.0-alpha00/owlcms_41.0.0-alpha00.zip) from the [release repository](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases)
