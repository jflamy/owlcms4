...
- Get a current release [zip](https://github.com/owlcms/owlcms4/releases/download/44.3.0/owlcms_44.3.0.zip) from the [release repository](https://github.com/owlcms/owlcms4/releases)
