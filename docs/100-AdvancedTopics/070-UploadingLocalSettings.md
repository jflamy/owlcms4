...
![120_localtemplates](img/070-UploadingLocalSettings/120_localtemplates.png)
...
![image-20260406162015819](img/070-UploadingLocalSettings/image-20260406162015819.png)

Then you can use the `Save installed OWLCMS version as zip` menu entry to create your kit
![image-20260406162110146](img/070-UploadingLocalSettings/image-20260406162110146.png)
...
![115_localoverride](img/070-UploadingLocalSettings/115_localoverride.png)