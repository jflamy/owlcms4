...
![Flag](img/090-FlagsPictures/Flag.png)
...
- This feature can be used in the cloud  Once you have tested your setup on a laptop, you will package the local directory and upload it to the cloud.  See the [Uploading Local Settings](./070-UploadingLocalSettings) page for details.
...
![FlagAndPicture](img/090-FlagsPictures/FlagAndPicture.png)
