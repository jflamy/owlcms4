...
### Basic Cloud-Based Setup
 ...
 The diagram below shows a simple club meet setup.  In this example, flags are used for refereeing, and the [speaker enters the decisions](../060-Refereeing/010-Refereeing.md#manual-refereeing).  For such a club meet,  the venue's WiFi provides the internet access. This is a starting point; you can then add all the other technical official stations and scoreboards that you may wish for; see later on this page.

![setup-club-simple](img/010-Fly/setup-club-simple-6554371.svg)
...
![20Login](img/010-Fly/20Login.png)
...
![image-20260717122244974](img/010-Fly/image-20260717122244974.png)
...
- [Phones are used as refereeing devices](../060-Refereeing/010-Refereeing.md#mobile-device-refereeing)
- A timekeeper uses a tablet
- A laptop is positioned in front of the athletes

![setup-club](img/010-Fly/setup-club-6553954.svg)
...
![setup-club-no-scoreboard-marshal-warmup](img/010-Fly/setup-club-no-scoreboard-marshal-warmup.svg)
