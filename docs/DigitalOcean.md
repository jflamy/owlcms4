...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/owlcms/owlcms4/releases/download/38.1.0-rc01/k3s_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/owlcms/owlcms4-prerelease/releases/download/38.1.0-rc01/k3s_setup.yaml | envsubst | kubectl apply -f - 
