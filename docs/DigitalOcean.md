...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/owlcms/owlcms4/releases/download/4.25.1/k3s_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/jflamy-dev/owlcms4-prerelease/releases/download/4.25.2-rc02/k3s_setup.yaml | envsubst | kubectl apply -f - 
>>>>>>> origin/develop
```
