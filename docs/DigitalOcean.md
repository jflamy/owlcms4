...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/download/45.0.0-beta01/k3s_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/owlcms/owlcms4-prerelease/releases/download/45.0.0-beta02/k3s_setup.yaml | envsubst | kubectl apply -f - 
