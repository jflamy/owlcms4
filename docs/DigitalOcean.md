...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/owlcms/owlcms4-prerelease/releases/download/45.0.0-alpha01/k3s_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/owlcms/owlcms4/releases/download/44.4.0/k3s_setup.yaml | envsubst | kubectl apply -f - 
>>>>>>> refs/heads/v24
```
