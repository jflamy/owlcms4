...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/owlcms/owlcms4/releases/download/4.15.4/k3s_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/owlcms/owlcms4/releases/download/4.15.5-rc01/k3s_setup.yaml | envsubst | kubectl apply -f - 
>>>>>>> origin/develop
```
