...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/owlcms/owlcms4-prerelease/releases/download/44.0.0-alpha02/k3s_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/owlcms/owlcms4-prerelease/releases/download/43.0.0-beta02/k3s_setup.yaml | envsubst | kubectl apply -f - 
