...
- Or, a small preview window.  The switch is done by using the icon at the top right of the preview window.
  ...
  ![scoreboard+athlete](img/040-UserInstructionsForZoom/scoreboard+athlete.png)

  In a real competition, the host would have selected an athlete and not a dummy background, obviously

  ![athlete+scoreboard](img/040-UserInstructionsForZoom/athlete+scoreboard.png)
...
![score_zoom_ipad](img/040-UserInstructionsForZoom/score_zoom_ipad.PNG)



![ath_zoom_ipad](img/040-UserInstructionsForZoom/ath_zoom_ipad.PNG)