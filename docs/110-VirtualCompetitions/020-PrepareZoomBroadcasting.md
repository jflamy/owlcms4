...
![zoomsettings](img/020-PrepareZoomBroadcasting/zoomsettings.png)
...
#### ![zoomsplit](img/020-PrepareZoomBroadcasting/zoomsplit.png)
...
- As described [here](./040-UserInstructionsForZoom), users can select whether they watch the video of the athlete or the scoreboard.
