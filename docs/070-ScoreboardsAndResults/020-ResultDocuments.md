...
![010_results](img/020-ResultDocuments/010_results.png)
...
![020_selectGroup](img/020-ResultDocuments/020_selectGroup.png)
...
![021_selectTemplate](img/020-ResultDocuments/021_selectTemplate.png)
...
![022_download](img/020-ResultDocuments/022_download.png)
...
![023_ExcelProtocol](img/020-ResultDocuments/023_ExcelProtocol.png)
...
> Note:  If [Score-based Medals](../040-CompetitionSetup/060-ScoreBasedCompetitions) are awarded for some age groups, this is not reflected in the Medals sheet.  You will have to use the `Scores` final package template to get a printable document.

![031_medalsExcel](img/020-ResultDocuments/031_medalsExcel.png)
...
![ChampionshipSelection](img/020-ResultDocuments/ChampionshipSelection.png )
...
- The `Scores` template is used when [Score-based Medals](../040-CompetitionSetup/060-ScoreBasedCompetitions) are awarded to the groups. For example, all U9 boys may compete together, and their Q-Youth score could be used for the medals.  The AgeGroups file would have specified "AGEFACTORS" as the scoring system for that age group.
