...
Several options are available for installation, depending on your needs. See the [Installation Overview](InstallationOverview) page for diagrams and a discussion of the following options:
  ...
  * Cloud installs for [Heroku](Cloud) (simple, free, recommended) or [Kubernetes](https://github.com/jflamy-dev/owlcms4-prerelease/releases/download/4.10.0-rc02/k8s.zip) (advanced).  An internet connection is required at the competition site, but less equipment is required and setup is simpler.
