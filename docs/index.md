...
<<<<<<< HEAD
  * Cloud installs for [Heroku](Heroku) (simple, free, recommended) or [Kubernetes](https://github.com/owlcms/owlcms4/releases/download/4.15.5/k8s.zip) (advanced).  An internet connection is required at the competition site, but less equipment is required and setup is simpler.
=======
  * Cloud installs for [Heroku](Heroku) (simple, free, recommended) or [Kubernetes](https://github.com/jflamy-dev/owlcms4-prerelease/releases/download/4.16.0-rc01/k8s.zip) (advanced).  An internet connection is required at the competition site, but less equipment is required and setup is simpler.
>>>>>>> origin/develop
