...
- **Get the installation zip archive**: Get the current  **[`owlcms_setup_51.0.0-beta01.zip`](https://github.com/owlcms/owlcms4-prerelease/releases/download/51.0.0-beta01/owlcms_setup_51.0.0-beta01.zip)** file. Installation files are available as assets at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) .
