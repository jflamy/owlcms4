...
- **Get the installation zip archive**: Get the current  [`owlcms_43.0.0-rc02.zip`](https://github.com/owlcms/owlcms4/releases/latest/download/owlcms_43.0.0-rc02.zip) file  (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) .
