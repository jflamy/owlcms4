...
- **Get the installation zip archive**: Go to the releases location (https://github.com/jflamy/owlcms4/releases/latest) and get the current `zip` file from the `assets` section at the bottom of the release entry.
