...
- **Get the installation zip archive**: Get the current  **[`owlcms_setup_47.1.0-beta03.zip`](https://github.com/owlcms/owlcms4-prerelease/releases/download/47.1.0-beta03/owlcms_setup_47.1.0-beta03.zip)** file. Installation files are available as assets at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) .
