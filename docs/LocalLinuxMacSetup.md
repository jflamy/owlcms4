...
- **Get the installation zip archive**: Get the current  **[`owlcms_setup_50.0.0-rc07.zip`](https://github.com/owlcms/owlcms4-prerelease/releases/download/50.0.0-rc07/owlcms_setup_50.0.0-rc07.zip)** file. Installation files are available as assets at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) .
