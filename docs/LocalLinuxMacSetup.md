...
- **Get the installation zip archive**: Get the current  [`owlcms_44.0.0-alpha13.zip`](https://github.com/owlcms/owlcms4-prerelease/releases/latest/download/owlcms_44.0.0-alpha13.zip) file  (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) .
