...
- **Get the installation zip archive**: Get the current  [`owlcms_38.0.0.zip`](https://github.com/owlcms/owlcms4/releases/latest/download/owlcms_38.0.0.zip) file  (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) .
