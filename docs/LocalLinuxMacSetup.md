...
- **Get the installation zip archive**: Get the current  **[`owlcms_setup_46.0.0-rc05.zip`](https://github.com/owlcms/owlcms4-prerelease/releases/download/46.0.0-rc05/owlcms_setup_46.0.0-rc05.zip)** file. Installation files are available as assets at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) .
