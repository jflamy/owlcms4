...
- **Get the installation zip archive**: Get the current  [`owlcms_36.0.0-alpha00.zip`](https://github.com/owlcms/owlcms4-prerelease/releases/latest/download/owlcms_36.0.0-alpha00.zip) file  (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) .
