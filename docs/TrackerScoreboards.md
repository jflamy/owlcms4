...
![image-20260924104220225](img/TrackerScoreboards/image-20260924104220225.png)
...
![image-20260924104643982](img/TrackerScoreboards/image-20260924104643982.png)
...
![image-20260924105131081](img/TrackerScoreboards/image-20260924105131081.png)

The application will then start and report it has started.  We then need to set a key to protect from vandalism.

![image-20260924130050871](img/TrackerScoreboards/image-20260924130050871.png)
...
<img src="img/TrackerScoreboards/image-20260924113639355.png" alt="image-20260924113639355" style="zoom:200%;" />

Then we enter the same information as on the owlcms-cloud screen and save. 

![image-20260924130145563](img/TrackerScoreboards/image-20260924130145563.png)

Then we start OWLCMS, and check that the connection worked.  The startup dialog will show

![image-20260924130457251](img/TrackerScoreboards/image-20260924130457251.png)

And the opening the remote URL will show

![image-20260924130832695](img/TrackerScoreboards/image-20260924130832695.png)
...
Let's assume we have also created an OWLCMS application under the name my-comp-owlcms.fly,dev (as explained on the [cloud installation page](Fly.md).  Configure the competition name in OWLMCS.
...
![image-20260924135210736](img/TrackerScoreboards/image-20260924135210736.png)

Once OWLCMS has started, it will connect to tracker and Tracker will update

![image-20260924135328691](img/TrackerScoreboards/image-20260924135328691.png)
...
![image-20260924135449435](img/TrackerScoreboards/image-20260924135449435.png)
...
![image-20260924140241468](img/TrackerScoreboards/image-20260924140241468.png)

<img src="img/TrackerScoreboards/image-20260924140336127.png" alt="image-20260924140336127" style="zoom:67%;" />