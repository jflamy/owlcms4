...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/owlcms/owlcms4/releases/download/4.33.0-alpha01/k3d_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/owlcms/owlcms4/releases/download/4.32.3/k3d_setup.yaml | envsubst | kubectl apply -f - 
>>>>>>> origin/master
```
