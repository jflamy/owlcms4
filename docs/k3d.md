...
```powershell
<<<<<<< HEAD
curl -sfL https://github.com/owlcms/owlcms4/releases/download/44.0.0-alpha03/k3d_setup.yaml | envsubst | kubectl apply -f - 
=======
curl -sfL https://github.com/owlcms/owlcms4/releases/download/43.0.0-beta03/k3d_setup.yaml | envsubst | kubectl apply -f - 
