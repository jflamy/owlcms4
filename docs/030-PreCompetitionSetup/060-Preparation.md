...
![030_Competition](img/060-Preparation/030_Competition.png) 

#### Standard Competition Rules

The screen also allows selecting common variations on IWF rules.

![031_options](img/060-Preparation/031_options.png)
...
OWLCMS also supports the IWF scenarios, and more complex scenarios with multiple age groups, please refer to the [Define Age Groups and Categories](./040-DefineAgeGroupsAndCategories) page for how to proceed for the following cases.
...
![050_EditGroups](img/060-Preparation/050_EditGroups.png)
...
![052_EnterOfficials](img/060-Preparation/052_EnterOfficials.png)
...
![060_EditFOP](img/060-Preparation/060_EditFOP.png)
...
![061_SelectFOP](img/060-Preparation/061_SelectFOP.png)
...
![062_SetSound](img/060-Preparation/062_SetSound.png)
