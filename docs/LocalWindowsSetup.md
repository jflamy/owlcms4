...
- **Windows Installer** : Get the current [`owlcms_setup_43.0.0-rc02.exe`](https://github.com/owlcms/owlcms4/releases/download/43.0.0-rc02/owlcms_setup_43.0.0-rc02.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) ).
