...
- **Windows Installer** : Get the current [`owlcms_setup_51.0.4.exe`](https://github.com/owlcms/owlcms4/releases/download/51.0.4/owlcms_setup_51.0.4.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) ).
