...
- **Windows Installer** : Get the current [`owlcms_setup.exe_37.4.0-beta01`](https://github.com/owlcms/owlcms4-prerelease/releases/download/37.4.0-beta01/owlcms_setup_37.4.0-beta01.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
