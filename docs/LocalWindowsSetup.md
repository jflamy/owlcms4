...
- **Windows Installer** : Get the current [`owlcms_setup.exe_38.3.0-rc02`](https://github.com/owlcms/owlcms4-prerelease/releases/download/38.3.0-rc02/owlcms_setup_38.3.0-rc02.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
