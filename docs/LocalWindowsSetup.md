...
- **Windows Installer** : Get the current [`owlcms_setup_44.0.2-rc01.exe`](https://github.com/owlcms/owlcms4-prerelease/releases/download/44.0.2-rc01/owlcms_setup_44.0.2-rc01.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
