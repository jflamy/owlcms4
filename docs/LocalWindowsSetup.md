...
- **Windows Installer** : Get the current [`owlcms_setup.exe_38.0.0-alpha01`](https://github.com/owlcms/owlcms4-prerelease/releases/download/38.0.0-alpha01/owlcms_setup_38.0.0-alpha01.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
