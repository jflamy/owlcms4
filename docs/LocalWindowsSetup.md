...
- **Windows Installer** : Get the current [`owlcms_setup_46.0.0-alpha05.exe`](https://github.com/owlcms/owlcms4-prerelease/releases/download/46.0.0-alpha05/owlcms_setup_46.0.0-alpha05.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
