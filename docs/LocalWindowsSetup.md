...
- **Windows Installer** : Get the current [`owlcms_setup_44.5.0-beta01.exe`](https://github.com/owlcms/owlcms4-prerelease/releases/download/44.5.0-beta01/owlcms_setup_44.5.0-beta01.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
