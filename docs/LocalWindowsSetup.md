...
- **Windows Installer** : Get the current [`owlcms_setup_48.0.0-rc10.exe`](https://github.com/owlcms/owlcms4-prerelease/releases/download/48.0.0-rc10/owlcms_setup_48.0.0-rc10.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
