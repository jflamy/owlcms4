...
- **Windows Installer** : Get the current [`owlcms_setup_44.2.2-rc02.exe`](https://github.com/owlcms/owlcms4-prerelease/releases/download/44.2.2-rc02/owlcms_setup_44.2.2-rc02.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
