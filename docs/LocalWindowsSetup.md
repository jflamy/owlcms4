...
<<<<<<< HEAD
- **Windows Installer** : Get the current [`owlcms_setup_45.0.0-beta01.exe`](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/download/45.0.0-beta01/owlcms_setup_45.0.0-beta01.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/latest) ).
=======
- **Windows Installer** : Get the current [`owlcms_setup_45.0.0-beta02.exe`](https://github.com/owlcms/owlcms4-prerelease/releases/download/45.0.0-beta02/owlcms_setup_45.0.0-beta02.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
