...
- **Windows Installer** : Get the current [`owlcms_setup.exe_38.1.0-beta03`](https://github.com/owlcms/owlcms4-prerelease/releases/download/38.1.0-beta03/owlcms_setup_38.1.0-beta03.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
