...
- **Windows Installer** : Get the current [`owlcms_setup_44.0.0-alpha15.exe`](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/download/44.0.0-alpha15/owlcms_setup_44.0.0-alpha15.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/latest) ).
