...
- **Windows Installer** : Get the current [`owlcms_setup.exe_39.0.0-rc01`](https://github.com/owlcms/owlcms4-prerelease/releases/download/39.0.0-rc01/owlcms_setup_39.0.0-rc01.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
