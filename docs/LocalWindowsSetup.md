...
- **Windows Installer** : Get the current [`owlcms_setup_49.0.5.exe`](https://github.com/owlcms/owlcms4/releases/download/49.0.5/owlcms_setup_49.0.5.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) ).
