...
- **Windows Installer** : Get the current [`owlcms_setup.exe_41.0.0-alpha02`](https://github.com/owlcms/owlcms4-prerelease/releases/download/41.0.0-alpha02/owlcms_setup_41.0.0-alpha02.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
