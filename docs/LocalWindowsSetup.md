...
- **Windows Installer** : Get the current [`owlcms_setup.exe_37.0.3-rc00`](https://github.com/owlcms/owlcms4-prerelease/releases/download/37.0.3-rc00/owlcms_setup_37.0.3-rc00.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
