...
- **Windows Installer** : Get the current [`owlcms_setup_46.0.3.exe`](https://github.com/owlcms/owlcms4/releases/download/46.0.3/owlcms_setup_46.0.3.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) ).
