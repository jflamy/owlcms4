...
- **Windows Installer** : Get the current [`owlcms_setup_48.0.5-rc01.exe`](https://github.com/owlcms/owlcms4-prerelease/releases/download/48.0.5-rc01/owlcms_setup_48.0.5-rc01.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4-prerelease/releases/latest) ).
