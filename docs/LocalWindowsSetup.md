...
- **Windows Installer** : Get the current [`owlcms_setup_44.6.0.exe`](https://github.com/owlcms/owlcms4/releases/download/44.6.0/owlcms_setup_44.6.0.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/owlcms/owlcms4/releases/latest) ).
