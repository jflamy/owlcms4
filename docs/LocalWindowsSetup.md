...
- **Windows Installer** : Get the current [`owlcms_setup_53.0.0-SNAPSHOT.exe`](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/download/53.0.0-SNAPSHOT/owlcms_setup_53.0.0-SNAPSHOT.exe) file (located in the `assets` section at the bottom of each release in the [release repository](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/latest) ).
