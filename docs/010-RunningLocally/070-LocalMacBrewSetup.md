...
- Using the Application icon ![image-20260603094422742](img/070-LocalMacBrewSetup/image-20260603094422742.png)  at the bottom of your screen in  the Dock, 

  1. Type `Terminal` to locate the Terminal application. You should see something like this.

  ![image-20260722114544654](img/070-LocalMacBrewSetup/image-20260722114544654.png)
...
- After the installation runs, OWLCMS control panel will be visible as owlcms in the Applications folder
  ![image-20260722114643974](img/070-LocalMacBrewSetup/image-20260722114643974.png)
