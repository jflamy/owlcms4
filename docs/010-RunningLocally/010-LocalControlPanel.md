...
The control panel works the same on all the platforms (Windows, Mac, Raspberry Pi, Linux).  At a competition, only one laptop runs the control panel and owlcms.  **To install the control panel for your computer, see the [Control Panel Installation page](./020-LocalDownloads).**

After starting the control panel, you can start and stop owlcms. To start it, use the Launch button
![image-20260717132553562](img/010-LocalControlPanel/image-20260717132553562.png)
...
![image-20260717132846200](img/010-LocalControlPanel/image-20260717132846200.png)
...
![image-20260717133123529](img/010-LocalControlPanel/image-20260717133123529.png)
...
![image-20260717133650476](img/010-LocalControlPanel/image-20260717133650476.png)

- The update does not touch the prior version, so you can always go back

![image-20260717133755668](img/010-LocalControlPanel/image-20260717133755668.png)
...
![image-20260717134055333](img/010-LocalControlPanel/image-20260717134055333.png)
...
![image-20260717134410894](img/010-LocalControlPanel/image-20260717134410894.png)
