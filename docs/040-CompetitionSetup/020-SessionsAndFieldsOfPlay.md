...
![image-20260718121015094](img/020-SessionsAndFieldsOfPlay/image-20260718121015094.png)

Clicking on the platform line allows you to rename or pick the audio output
<img src="img/020-SessionsAndFieldsOfPlay/image-20260718121139927.png" alt="image-20260718121139927" style="zoom:50%;" />
...
If you load an empty database, the sessions screen looks like this, with all sessions empty.  If you have used the Excel spreadsheet method described on the [Registration](./010-Registration.md) page, there will be athletes assigned to the sessions.

![image-20260718122230208](img/020-SessionsAndFieldsOfPlay/image-20260718122230208.png)

Clicking on a session brings up an editing popup with tabs.

#### Session

![image-20260718122336240](img/020-SessionsAndFieldsOfPlay/image-20260718122336240.png)
...
![image-20260718123121553](img/020-SessionsAndFieldsOfPlay/image-20260718123121553.png)

Often, officials will be determined in advance; see the [Technical Officials Assignment](../100-AdvancedTopics/050-TechnicalOfficials) page for details.  If a list of technical officials has been provided, you can select by typing in the drop box.  This screen is typically used for last minute changes, or for small competitions.
