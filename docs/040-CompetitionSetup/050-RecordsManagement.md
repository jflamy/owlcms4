...
![records](img/050-RecordsManagement/records.png)
...
If records are broken during a meet, they are stored in the database with the session in which the record was broken.  This marks them as *provisional* records. This provisional status needs to be explicitly accepted for the record to become official (see below).  The federation can then update its file and re-publish a new Excel.  It is possible to set up a [Record Repository](../100-AdvancedTopics/060-RecordsRepository) to make these tasks easier.

## Record Management

The Record Management pages reached from the Records menu item

![image-20260603115701984](img/050-RecordsManagement/image-20260603115701984.png)

### Loading Records

To add records to the database, use the Import button

![image-20260603150656099](img/050-RecordsManagement/image-20260603150656099.png)

This works like the other Upload features in OWLCMS. 

![image-20260603150835603](img/050-RecordsManagement/image-20260603150835603.png)

After selection, a summary of the to-be-imported file is shown for confirmation

![image-20260603151850494](img/050-RecordsManagement/image-20260603151850494.png)

And the content is updated

![image-20260603163555701](img/050-RecordsManagement/image-20260603163555701.png)

We then upload a second set of files, for national records, and we can filter what records are shown

![image-20260603163759906](img/050-RecordsManagement/image-20260603163759906.png)

### Editing Individual Records

Clicking on a record opens an editing form

![image-20260603163945194](img/050-RecordsManagement/image-20260603163945194.png)
...
![image-20260603164959645](img/050-RecordsManagement/image-20260603164959645.png)
...
![image-20260618092520914](img/050-RecordsManagement/image-20260618092520914.png)


Use a "dataExchange" template will produce an Excel File that you can then load into OWLCMS or in a [Record Repository](../100-AdvancedTopics/060-RecordsRepository)
![image-20260603165707050](img/050-RecordsManagement/image-20260603165707050.png)
...
![image-20260603165937078](img/050-RecordsManagement/image-20260603165937078.png)
...
![image-20260316142736214](img/050-RecordsManagement/image-20260316142736214.png)
...
![60](img/050-RecordsManagement/60.png)
...
![](img/050-RecordsManagement/excel.png)
