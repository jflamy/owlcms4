...
1. On the machine where you want to run OBS, start the status monitor![statusMonitorStart](img/040-OBSSceneSwitching/statusMonitorStart.png)
...
![statusMonitorExample](img/040-OBSSceneSwitching/statusMonitorExample.png)
...
3. Restart OBS.
4. Go to the Tools / Advanced Scene Switcher menu, and start the plugin if needed. ![AdvSceneSwitcher](img/040-OBSSceneSwitching/AdvSceneSwitcher.png)
...
![example1](img/040-OBSSceneSwitching/example1.png)
...
![example2](img/040-OBSSceneSwitching/example2.png)
