...
![CreateEvent](img/020-Streaming/CreateEvent.png)

2. Go through the wizard.  Make sure you select Facebook Live and enter the description for your Event, etc. ![FacebookLive](img/020-Streaming/FacebookLive.png)
...
6. Go back to OBS,  Open the File - Settings menu.  Select Streaming.  Erase the streaming key and paste the one you just got from Facebook.
   ...
   ![SetStreamingKey](img/020-Streaming/SetStreamingKey.png)

6. Close the settings page.  In OBS, at the bottom right, you will find a "Start Streaming" Button
   ![StartStreaming](img/020-Streaming/StartStreaming.png)
