...
class RefereeJuryStyles {
	...
	/**
	 * Creates an empty component that absorbs the unused vertical space of the launcher page. It
	 * must be added just before the navigation links so that they are pushed down to the bottom of
	 * the area that remains visible once the mobile browser decorations are taken into account.
	 *
	 * @return a flexible filler
	 */
	static Div verticalFiller() {
		Div filler = new Div();
		filler.addClassName("referee-jury-home-filler");
		return filler;
	}
