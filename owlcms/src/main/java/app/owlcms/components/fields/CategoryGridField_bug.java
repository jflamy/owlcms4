...
public class CategoryGridField_bug extends CustomField<List<Category>> {

	Collection<Button> editButtons = Collections.newSetFromMap(new WeakHashMap<>());

	Logger logger = (Logger) LoggerFactory.getLogger(CategoryGridField_bug.class);
	...
	public CategoryGridField_bug(AgeGroup ag) {
		...
		catGrid = new Grid<>();
		catGrid.addColumn(Category::getLimitString)
	...
	private void setupEditing(Grid<Category> grid) {
		...
		qualTotField.getElement().addEventListener("click", ignore -> {}).addEventData("event.stopPropagation()");
		...
		Grid.Column<Category> editorColumn = catGrid.addComponentColumn(cat -> {
			...
			edit.getElement().addEventListener("click", ignore -> {}).addEventData("event.stopPropagation()");
			...
			delete.getElement().addEventListener("click", ignore -> {}).addEventData("event.stopPropagation()");
