 ...
 * in the client-side. Can optionally prompt the user before leaving the page.
 *
 * @author miki
 * @since 2020-04-29
 */
...
public class UnloadEvent extends ComponentEvent<UnloadObserver> {
	 ...
	 *                  querying before unloading; {@code false} otherwise.
	 */
	 ...
	 * user on {@code beforeunload} browser event.
	 *
	 * @return {@code true} when event is in response to querying the user on
	 *         {@code beforeunload}, {@code false} otherwise.
	 */
