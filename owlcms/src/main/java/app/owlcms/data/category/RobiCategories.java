...
/**
 * This class is used to compute the Robi score for athletes based on their body
 * weight. It locates what the athlete's category if the Athlete was competing
