...
public class AbstractLifterComparator {
    ...
    int comparePreviousAttempts(int startingFrom, boolean excludeSnatch, Athlete lifter1, Athlete lifter2) {
        ...
        if (startingFrom >= 6) {
            compare = ((Integer) Math.abs(Athlete.zeroIfInvalid(lifter1.getCleanJerk3ActualLift()))).compareTo(Math
                    .abs(Athlete.zeroIfInvalid(lifter2.getCleanJerk3ActualLift())));
            if (trace)
        ...
        if (startingFrom >= 5) {
            compare = ((Integer) Math.abs(Athlete.zeroIfInvalid(lifter1.getCleanJerk2ActualLift()))).compareTo(Math
                    .abs(Athlete.zeroIfInvalid(lifter2.getCleanJerk2ActualLift())));
            if (trace)
        ...
        if (startingFrom >= 4) {
            compare = ((Integer) Math.abs(Athlete.zeroIfInvalid(lifter1.getCleanJerk1ActualLift()))).compareTo(Math
                    .abs(Athlete.zeroIfInvalid(lifter2.getCleanJerk1ActualLift())));
            if (trace)
        ...
        if (startingFrom >= 3) {
            compare = ((Integer) Math.abs(Athlete.zeroIfInvalid(lifter1.getSnatch3ActualLift()))).compareTo(Math
                    .abs(Athlete.zeroIfInvalid(lifter2.getSnatch3ActualLift())));
            if (trace)
        ...
        if (startingFrom >= 2) {
            compare = ((Integer) Math.abs(Athlete.zeroIfInvalid(lifter1.getSnatch2ActualLift()))).compareTo(Math
                    .abs(Athlete.zeroIfInvalid(lifter2.getSnatch2ActualLift())));
            if (trace)
        ...
        if (startingFrom >= 1) {
            compare = ((Integer) Math.abs(Athlete.zeroIfInvalid(lifter1.getSnatch1ActualLift()))).compareTo(Math
                    .abs(Athlete.zeroIfInvalid(lifter2.getSnatch1ActualLift())));
            if (trace)
     ...
     * @return the int
     */
    protected int compareClub(Athlete lifter1, Athlete lifter2) {
        ...
        if (club2 == null)
            return 1;
        return lifter1.getTeam().compareTo(lifter2.getTeam());
    }
