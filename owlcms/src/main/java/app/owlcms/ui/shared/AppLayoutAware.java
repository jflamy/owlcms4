...
public interface AppLayoutAware {
     ...
     * 
     * A RouterLayout is referenced as a layout by some Content, meaning that the
     * content will be inserted inside and laid out (i.e. displayed).
     * OwlcmsRouterLayout delegates to an AppLayout which actually does the
     * layouting. AppLayout is a Java API to the Google app-layout web component.
     * 
