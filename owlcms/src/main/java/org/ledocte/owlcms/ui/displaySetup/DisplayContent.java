...
public class DisplayContent extends VerticalLayout {
	...
	public DisplayContent() {
        ...
        layout.withTemplateRows(new Flex(1), new Flex(1), new Flex(1), new Flex(1))
                ...
                .withMargin(false)
                .withRowAndColumn(new Button("Results Screen", buttonClickEvent -> UI.getCurrent().navigate(CategoryContent.class)), 2, 2)
