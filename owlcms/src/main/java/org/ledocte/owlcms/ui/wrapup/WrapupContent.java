...
public class WrapupContent extends VerticalLayout {

	public WrapupContent() {
        ...
        layout.withTemplateRows(new Flex(1), new Flex(1), new Flex(1), new Flex(1))
                ...
                .withMargin(false)
                .withRowAndColumn(new Button("Competition Book", buttonClickEvent -> UI.getCurrent().navigate(CategoryContent.class)), 2, 2)
                .withRowAndColumn(new Button("Timing Statistics", buttonClickEvent -> UI.getCurrent().navigate(AttemptBoard.class)), 2, 3)
//                .withRowAndColumn(new Button("Referee Decision Display", buttonClickEvent -> UI.getCurrent().navigate(CategoryContent.class)), 2, 4)
//                .withRowAndColumn(new Button("Jury Display", buttonClickEvent -> UI.getCurrent().navigate(CategoryContent.class)), 3, 2)
//                .withRowAndColumn(new Button("Plates Display", buttonClickEvent -> UI.getCurrent().navigate(CategoryContent.class)), 3, 3)
                ;
        layout.setWidth("100%");
