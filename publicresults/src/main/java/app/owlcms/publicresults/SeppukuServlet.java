...
public class SeppukuServlet extends HttpServlet implements Traceable {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        new Thread(() -> {
            throw new ExitException("restarting.");
        }).start();
    }
    ...
    public Logger getLogger() {
        return (Logger) LoggerFactory.getLogger(SeppukuServlet.class);
    }
    ...
    public static void syncBreakTimer(String fopName2, BreakTimerElementPR breakTimer) {
        ...
        var logger = (Logger) LoggerFactory.getLogger(SeppukuServlet.class);
