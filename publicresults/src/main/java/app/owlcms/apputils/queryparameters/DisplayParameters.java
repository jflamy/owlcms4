...
public interface DisplayParameters extends ContentParameters {
    ...
    public static final String LIFTING_ORDER = "lifting";
    ...
    public default void setDefaultLiftingOrderDisplay(boolean b) {
    }
    ...
    public default void switchLightingMode(Component target, boolean dark, boolean updateURL) {
        ...
        target.getElement().setProperty("darkMode", dark ? DARK : LIGHT);
        if (updateURL) {
