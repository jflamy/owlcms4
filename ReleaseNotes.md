#### **Changes for release 4.29.0-beta02**  ([Full Log](https://github.com/jflamy/owlcms4/issues?utf8=%E2%9C%93&q=is%3Aclosed+is%3Aissue+project%3Ajflamy%2Fowlcms4%2F1+))
...
4.29.0-beta02: The [Refereeing](https://owlcms.github.io/owlcms4-prerelease/#/Refereeing) and [Jury](https://owlcms.github.io/owlcms4-prerelease/#/Jury) documentation pages were updated to cover the different kinds of devices and the new Jury console features.

##### New in release 4.29

- [x] [Jury](https://owlcms.github.io/owlcms4-prerelease/#/Jury) console now supports summoning the referees either individually or all together.  This feature works for phones/tablets/laptops using the refereeing screen, or with [MQTT refereeing devices]() (see below)
...
- [x] It is now possible to build affordable physical devices to receive instructions from owlcms (decision expected, jury calls referee).
  ...
  - An MQTT server is used to broker communications between owlcms and the devices. See [MQTT setup instructions](https://owlcms.github.io/owlcms4-prerelease/#/MQTT) for details for configuration of a free broker.
...
- [x] New: A new status monitoring window enables automatic video scene switching in OBS.  See [documentation](https://owlcms.github.io/owlcms4-prerelease/#/OBSSceneSwitching) and [tutorial video](https://user-images.githubusercontent.com/678663/147373848-89b91086-b16d-48c0-8f48-445f6c1ca828.mp4)
