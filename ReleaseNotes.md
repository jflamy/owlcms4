...
- (45.0.5) New BENCHMARK value for OWLCMS_INITIALDATA. This creates a very large competition with 4 concurrent platforms and 1154 athletes of all IWF and Masters age groups. See [documentation](https://owlcms.github.io/owlcms4-prerelease/#/Configuration).
