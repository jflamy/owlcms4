#### **Changes for release 4.28.0-beta01**  ([Full Log](https://github.com/jflamy/owlcms4/issues?utf8=%E2%9C%93&q=is%3Aclosed+is%3Aissue+project%3Ajflamy%2Fowlcms4%2F1+))

4.28.0-beta01: Added the list of expected status transitions to the OBS scene switching [documentation](https://owlcms.github.io/owlcms4-prerelease/#/OBSSceneSwitching) 

##### New in release 4.28

- [x] Enhancements and fixes to the status monitor used for Open Broadcaster Software (OBS) automated scene switching.  Improvements to the processing of end-of-group scenarios (withdrawal without a decision, jury decision after the last lift, etc.). Added [documentation](https://owlcms.github.io/owlcms4-prerelease/#/OBSSceneSwitching) for all supported transitions.
