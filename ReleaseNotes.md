...
- [x] It is now possible to build affordable physical devices to receive instructions from owlcms (decision expected, jury calls referee).
  ...
  - An MQTT server is used to broker communications between owlcms and the devices. See [MQTT setup instructions](https://owlcms.github.io/owlcms4/#/MQTT) for details for configuration of a free broker.
