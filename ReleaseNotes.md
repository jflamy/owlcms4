...
- 34.0.2-rc03:  Fix: In a combined Snatch + Clean & Jerk + Total competition, the team scoreboards and team results screen in the application were not showing the combined points (but the Final Results Package was correct).
