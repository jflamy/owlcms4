...
* Key Highlights from recent stable releases
  ...
  * [x] [4.20.2] Moving down was wrongly being denied if C&J move down was less than last snatch attempted.
  * [x] [4.20.2] Moving down was wrongly being denied when athlete requesting change down to current weight was at a later attempt than athlete whose clock had started.
  * [x] [4.20.2] Not assigning start numbers was preventing Marshal and Announcer from editing athlete.
