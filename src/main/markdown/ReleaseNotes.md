...
59.0.0: An error message will be emitted if, when loading a session, an athlete has no category.  The athlete will be ignored and not added to the session.  This prevents having to check for a category on all the scoreboards, etc.
