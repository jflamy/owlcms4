* Changes for release ${revision}  ([Full Log](https://github.com/jflamy/owlcms4/issues?utf8=%E2%9C%93&q=is%3Aclosed+is%3Aissue+project%3Ajflamy%2Fowlcms4%2F1+))
  ...
  * [x] 4.19.0-rc01 Error message for 20kg rule was broken in release 4.19.0. Fixed.
  * [x] 4.19.0-rc02 Fixed an exception when writing to the log file if no start number was assigned to an athlete.
  * [x] 4.19.0-rc03 Added a local/logback.xml file to the default install so it is easier to change the logging levels when troubleshooting.
