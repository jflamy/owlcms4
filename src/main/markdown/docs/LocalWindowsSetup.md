...
- **Windows Installer** : Get the current installation file called `owlcms_setup.exe` from the [releases page](https://github.com/${env.REPO_OWNER}/${env.O_REPO_NAME}/releases/latest)  (see the "Assets" section below the release notes).
